...
//Ganti link foto lu
const thumblo = "https://i.ibb.co/ZB2xvtC/favicon-custom.jpg"
//Diemin aje
...
Instagram : *@ziptatopup*
Info Github : *RAProjects*`
               buttons = [
...
{buttonId: `${prefix}storegame`,buttonText:{displayText: 'STORE GAME 💎'},type:1}
       ...
       if (!isUser) return reply(mess.noregis)
               list = []
               listmenu = [`ff`,`mla`,`coa`]
               listmenuu = [`Store Free Fire`,`Store Mobile Legend A`,`Crystl Of Aurora`]
               nombor = 1
               startnum = 0
...
5532 💎 = Rp. 1.102.400`
               ...
               buttons = [
{buttonId: '!idml',buttonText:{displayText: '𝗙𝗢𝗥𝗠𝗔𝗧'},type:1}]
...
1440 💎 = Rp. 178.000
2000 💎 = Rp. 242.727
MEMBERSHIP MINGGUAN = Rp. 26.970
MEMBERSHIP BULANAN = Rp. 134.848`

               buttons = [
{buttonId: '!idff',buttonText:{displayText: '𝗙𝗢𝗥𝗠𝗔𝗧'},type:1}]
...
COA Mingguan = Rp. 33.000
COA Bulanan     = Rp. 68.000
COA M + B         = Rp. 101.000`

               buttons = [
{buttonId: '!vilog',buttonText:{displayText: '𝗙𝗢𝗥𝗠𝗔𝗧'},type:1}]
...
gopeynya = `${thumblo}`
teksnya = `[ 𝗜𝗡𝗙𝗢 𝗣𝗘𝗦𝗔𝗡𝗔𝗡 ]
𝗦𝘁𝗮𝘁𝘂𝘀 𝗣𝗲𝘀𝗮𝗻𝗮𝗻 ➪ ᴘʀᴏᴄᴇs
𝗧𝗮𝗻𝗴𝗴𝗮𝗹 ➪ *${week} - ${calender}*
[ 𝗪𝗮𝗸𝘁𝘂 ]
𝗪𝗜𝗕  ➪ ${timeWib} WIB
𝗪𝗜𝗧   ➪ ${timeWit}  WIT
𝗪𝗜𝗧𝗔➪ ${timeWita} WITA

[ 𝗦𝗜𝗟𝗔𝗛𝗟𝗔𝗡 𝗧𝗨𝗡𝗚𝗚𝗨 𝗦𝗘𝗕𝗘𝗡𝗧𝗔𝗥 ]`
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UCt-8NlDbG_BpscOYvgW2jiA`)
              break
       case 'masukandata':
...
ZIPTA DROP DATA✅
➪https://chat.whatsapp.com/BSX4ixRbSk70gHqoePFHTf

ZIPTA SOC✅
➪https://chat.whatsapp.com/Dce9LVBVkqt8ejtqtRC2Fo

JB ZIPTA I✅
➪https://chat.whatsapp.com/EgIVufRmJlH2ixQ6QsFD9K

*[ ITU SEMUA LINK GRUB ZIPTA ]*`
Xrutz.sendMessage(from, await getBuffer(gopeynya), image, {quoted: fakekontak, caption: teksnya })
              break
...
//========== [ Menunya Bang:v ] ==========
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             replyf(`Follow Instagram Owner Ya : https://www.instagram.com/ziptatopup`)
             break
      case 'grupbot':
...
const rutz = `https://youtube.com/channel/UCt-8NlDbG_BpscOYvgW2jiA`
